    ...
    <div style={{ 
      ...
      <main style={{ 
        ...
        <article style={{
          ...
          <div style={{ fontSize: '18px', lineHeight: '1.8', marginBottom: '35px' }}>
            <p style={{ 
              margin: '0 0 25px 0',
              color: '#2d3748',
              fontSize: '20px',
          ...
          <div style={{ 
            ...
            <p style={{ 
              ...
              نسعى لجعل التكنولوجيا في متناول الجميع من خلال تقديم محتوى مبسط ومفهوم باللغة العربية، مما يساهم في نشر ال��عرفة التقنية في المنطقة العربية.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <p style={{ 
                ...
                <strong style={{ color: '#667eea' }}>البريد الإلكتروني:</strong> info@tech2025.com
              </p>
              <p style={{ 
                margin: 0,
                padding: '15px',
                ...
                <strong style={{ color: '#667eea' }}>الموقع:</strong> www.tech2025.com
              </p>
              <p style={{ 
                margin: 0,
                padding: '15px',
